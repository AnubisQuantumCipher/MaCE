...
# MaCE v3.2 Linux Installation Script - IMPROVED VERSION
# Addresses issues found during testing

set -e

echo "🚀 MaCE v3.2 Linux Installation Script (Improved)"
echo "=================================================="
...
# Install Swiftly (Swift toolchain manager) with automatic yes
print_status "Installing Swiftly..."
if ! command -v swiftly &> /dev/null; then
    print_status "Downloading and installing Swiftly automatically..."
...
echo ""
print_success "🌟 MaCE is ready for production use!"
